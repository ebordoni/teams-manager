...
> Stato attuale: **MVP operativo (v0.19.4)** — include piani partita AI multi-provider con rotazioni validate, fallback locale ed export in Google Docs.
...
GET    /api/events/:id/attendance  -- un record per giocatore; `recorded: false`
