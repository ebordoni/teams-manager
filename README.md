...
[![Version](https://img.shields.io/badge/version-0.14.0-blue)](addon/CHANGELOG.md)
...
> ✅ **Stato: MVP operativo (v0.14.0).** Calendario, giocatori, presenze, formazioni, piani partita AI e comunicazioni Google sono disponibili; la roadmap residua è descritta in [`SPECS.md`](SPECS.md).
