...
[![Version](https://img.shields.io/badge/version-0.19.6-blue)](addon/CHANGELOG.md)
...
> ✅ **Stato: MVP operativo (v0.19.6).** Calendario, giocatori, presenze, formazioni, piani partita AI ed esportazioni Google sono disponibili; la roadmap residua è descritta in [`SPECS.md`](SPECS.md).
