...
> ✅ **Stato: MVP operativo (v0.12.0).** Calendario, giocatori, convocazioni, presenze, formazioni, piani partita AI e comunicazioni Google sono disponibili; la roadmap residua è descritta in [`SPECS.md`](SPECS.md).
