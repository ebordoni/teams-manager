...
[![Version](https://img.shields.io/badge/version-0.4.0-blue)](addon/CHANGELOG.md)
...
> ✅ **Stato: MVP operativo (v0.4.0).** Calendario, giocatori, convocazioni, presenze e comunicazioni Google sono disponibili; la roadmap residua è descritta in [`SPECS.md`](SPECS.md).
