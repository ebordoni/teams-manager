...
[![Version](https://img.shields.io/badge/version-0.6.0-blue)](addon/CHANGELOG.md)
...
> ✅ **Stato: MVP operativo (v0.6.0).** Calendario, giocatori, convocazioni, presenze e comunicazioni Google sono disponibili; la roadmap residua è descritta in [`SPECS.md`](SPECS.md).
