...
[![Version](https://img.shields.io/badge/version-0.7.0-blue)](addon/CHANGELOG.md)
...
> ✅ **Stato: MVP operativo (v0.7.0).** Calendario, giocatori, convocazioni, presenze, formazioni e comunicazioni Google sono disponibili; la roadmap residua è descritta in [`SPECS.md`](SPECS.md).
